...
struct jcgo_reflect_s
{
 ...
 jObjectArr methodsParamAnnoArgs; /* Slice #3: per-method String[][] parallel to methodsParamAnnos with raw arg-text per (parameter, annotation) */
 jObjectArr methodsDefault;   /* Slice #1: per-method String of raw `default V` text for annotation members; NULL when no method has a default */
