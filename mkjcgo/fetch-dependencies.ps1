# Fetch the third-party tarballs the MSVC build scripts expect under
# contrib/. Idempotent -- skips download/extract if the destination
# already has the marker file we expect.
#
# What this fetches:
...
Write-Host ""
Write-Host "Dependencies ready under contrib/."
